...
describe('MeasurementService', () => {
  ...
  describe('mapFeedMeasurementDataToMeasurement', () => {
    it('maps all fields correctly', () => {
      const result = service.mapFeedMeasurementDataToMeasurement(mockAIOFeedData);
    ...
    it('parses value as float via parseFloat', () => {
      const result = service.mapFeedMeasurementDataToMeasurement({
        ...mockAIOFeedData,
        value: '3.14',
      });
  ...
  describe('getMeasurements', () => {
    it('calls ApiService.get with correct URL containing locationKey', () => {
      ...
      service.getMeasurements('my-location').subscribe();
    ...
    it('sets limit param to feedDataLimit (1000)', () => {
      ...
      service.getMeasurements('loc').subscribe();
    ...
    it('includes start_time when start Date is provided', () => {
      ...
      service.getMeasurements('loc', start).subscribe();
    ...
    it('includes end_time when end Date is provided', () => {
      ...
      service.getMeasurements('loc', undefined, end).subscribe();
    ...
    it('includes both start_time and end_time when both Dates provided', () => {
      ...
      service.getMeasurements('loc', start, end).subscribe();
    ...
    it('maps AIOFeedData[] to Measurement[] correctly', () => {
      const apiResponse = cold('a|', { a: [mockAIOFeedData] });
      apiGetSpy.mockReturnValue(apiResponse);

      const result = service.getMeasurements('loc');
      ...
      expect(result).toBeObservable(cold('a|', { a: [expectedMeasurement] }));
    });
    ...
    it('throws error when API returns empty array', () => {
      ...
      expect(result).toBeObservable(
        cold('#', undefined, new Error('0 Measurements received from API.')),
      );
    });
